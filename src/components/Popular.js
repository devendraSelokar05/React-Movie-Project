...
//       </div>
//       <div>
//         <img src="https://upload.wikimedia.org/wikipedia/en/thumb/f/f0/Shaitaan_2024_film_theatrical_poster.jpeg/220px-Shaitaan_2024_film_theatrical_poster.jpeg" alt="shaitaan" />
//       </div>
//       <div>
//         <img src="https://m.media-amazon.com/images/M/MV5BMzI5YTkyODQtZWRmZC00MGMzLTg2YTUtNmZiODdmYWM4NWNmXkEyXkFqcGc@._V1_.jpg" alt="bad newz" />
//       </div>
//       <div>
//         <img src="https://upload.wikimedia.org/wikipedia/en/7/7f/No_Gain_No_Love.png" alt="no gain no love" />
//       </div>
//       <div>
//         <img src="https://m.media-amazon.com/images/M/MV5BNmQ5Zjg2ZTYtMGZmNC00M2Y3LTgwZGQtYmQ3NWI5MDdhZWNjXkEyXkFqcGc@._V1_.jpg" alt="demons layer" />
//       </div>
//       <div>
//         <img src="https://static1.srcdn.com/wordpress/wp-content/uploads/2023/03/friends-tv-series-poster.jpg" alt="Friends" />
//       </div>
//       <div>
//         <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRjp_z665pJroNgf2YGojHoApx1vB4d8qiK3Q&s" alt="flames" />
//       </div>
//       <div>
//         <img src="https://resizing.flixster.com/Umubfp25u4Neqq2gSgyHUgEjfBY=/fit-in/705x460/v2/https://resizing.flixster.com/-XZAfHZM39UwaGJIFWKAE8fS0ak=/v3/t/assets/p18829068_b_h9_aa.jpg" alt="Alice in borderland" />
//       </div>
//       <div>
//         <img src="https://m.media-amazon.com/images/I/81ecxwQEHLL._AC_UF1000,1000_QL80_.jpg" alt="Darling in the frankxx" />
//       </div>
//       <div>
//         <img src="https://m.media-amazon.com/images/M/MV5BZjJlMTNiYjItMTgxYy00YjRlLTg0NGItYjY1MWNlMGZhNWNmXkEyXkFqcGc@._V1_.jpg" alt="indori ishq" />
//       </div>
//       <div>
//         <img src="https://m.media-amazon.com/images/M/MV5BMjM1ZmViMmYtOGYzZC00YzhmLWE0MTMtMzNjYzcyNjEwYWRkXkEyXkFqcGc@._V1_.jpg" alt="evil Dead Rise" />
//       </div>
// </div>
// </div>
...
const Popular = () => {
  const [movies, setMovies] = useState([]);
    ...
    return (
        <div>
            <div className='main-container'>
                <h4 className='TV' style={{color:'white'}}>Popular Movies and TV Shows - JustWatch India</h4>
                <div className='para text-secondary'>
                    <p>We are glad you're here! With JustWatch you can easily find where to watch your favourite movies & TV series on streaming services in India.</p>
                    <p>JustWatch is easy and effective: choose your favourite streaming services in the WatchBar below and see what’s on Netflix, Amazon Prime Video India, Hotstar, and many more.</p>
                    <p>This guide is organized by popularity to help you find today's most popular movies and TV shows in India...</p>
                </div>
                <div className="logo">
                    <Carousel showArrows={true} showThumbs={false} infiniteLoop={true} autoPlay={true} interval={2000}>
                        <div>
                            <img src='https://i.ytimg.com/vi/w5cA1pHcBNc/maxresdefault.jpg' alt='Popular movie' />
                        </div>
                        <div>
                            <img src='https://seeklogo.com/images/A/amazon-prime-video-logo-1B919AB668-seeklogo.com.png' alt='Amazon Prime Video' />
                        </div>
                        <div>
                            <img src='https://www.apple.com/v/apple-tv-plus/ai/images/meta/apple-tv__e7aqjl2rqzau_og.png?202406180149' alt='Apple TV Plus' />
                        </div>
                        <div>
                            <img src='https://i.gadgets360cdn.com/large/disney_plus_hotstar_logo_1583901149861.jpg' alt='Hotstar' />
                        </div>
                        <div>
                            <img src='https://images.firstpost.com/uploads/2023/12/jiocinema.jpg?im=FitAndFill=(1200,675)' alt='Jio Cinema' />
                        </div>
                        <div>
                            <img src='https://upload.wikimedia.org/wikipedia/commons/5/5a/Zee5-official-logo.jpeg' alt='Zee5' />
                        </div>
                        <div>
                            <img src='https://thumbs.dreamstime.com/b/google-play-app-store-icons-simple-vector-filled-flat-google-play-app-store-icons-logo-solid-pictogram-isolated-white-159029210.jpg' alt='Google Play' />
                        </div>
                        <div>
                            <img src='https://i.vimeocdn.com/video/1425455159-830ae785608a4ee90dd9595dac7d22dc3ec807a84bcff3f80c5067a43322987d-d_640?f=webp' alt='Vimeo' />
                        </div>
                        <div>
                            <img src='https://origin-staticv2.sonyliv.com/UI_icons/fallback_sonyliv_logo.png' alt='Sony Liv' />
                        </div>
                        <div>
                            <img src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSEynCGDrFj3BQG1Aff7q4ARbWM0s7FK8jfng&s' alt='Stream service' />
                        </div>
                        <div>
                            <img src='https://burritobuzz.com/wp-content/uploads/2016/07/netflix-kids.jpg' alt='Netflix Kids' />
                        </div>
                        <div>
                            <img src='https://variety.com/wp-content/uploads/2024/02/Tubi-Logo.png' alt='Tubi' />
                        </div>
                        <div>
                            <img src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcScSvkVspNdOkRTNEU_q8lr_f2Er4aVbykGoA&s' alt='Another service' />
                        </div>
                        <div>
                            <img src='https://play-lh.googleusercontent.com/jFi2iC10wQJ42gu-DO2CMeIcN3qcmNQHtY5EBT_wtp4jCIozS4n3Q9pA7ZloDUGHHw' alt='Stream service' />
                        </div>
                    </Carousel>
                </div>
                <div className='title'>
                ...
                <div className="card-body" id='card-container'>
                    {movies.map(movie => (
                        <div className="movie-card" key={movie.id} onClick={() => redirectToMovieDetails(movie.id)}>
                            <img src={movie.posterImage} alt={`${movie.title} Poster`} loading='lazy' />
                        </div>
                    ))}
                </div>
            </div>
            <div className="d-flex justify-content-center align-items-center button-container">
                <button className="btn-primary custom-btn" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" aria-controls="offcanvasExample">
                    Watch More
                </button>
                <Link to="/contact" className="justify-content-center align-items-center">
            ...
            <div className="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
                ...
                <div className="offcanvas-body">
                    ...
                    <div className="dropdown">
                        <button className="ggg" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown">
                            Some More
                        </button>
                        <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton">
